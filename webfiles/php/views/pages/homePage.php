<body>
    ...
    <main>
        <div class="img_presentation">
            <img class="img1" src="/assets/img/presentation1.jpg" alt="photo de nos savons">
            <img class="img2" src="/assets/img/presentation3.jpg" alt="photo de nos savons">
            <img class="img3" src="/assets/img/presentation2.jpg" alt="photo de nos savons">
        </div>
        ...
        <div>
            <article>
                <div class="atelier">
                    ...
                    <div class="content">
                        <img src="/assets/img/creation.jpg" alt="photo de nos créations">
